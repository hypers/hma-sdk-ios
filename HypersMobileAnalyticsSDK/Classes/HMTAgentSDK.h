...
+ (BOOL)postActionStart:(NSString *)action uactSign:(NSString *)uact;
+ (BOOL)postActionEnd:(NSString *)action uactSign:(NSString *)uact property:(NSDictionary *)property callback:(void(^)(void))callback;
